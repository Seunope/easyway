...
export default {
  ...
  // Button
  buttonFontFamily: platform === PLATFORM.IOS ? 'System' : 'Muli-Bold',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === PLATFORM.IOS ? 'System' : 'Muli-Light',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  // Title
  titleFontfamily: platform === PLATFORM.IOS ? 'System' : 'Muli-Bold',
